...
plt.subplot(521)
plt.plot(t1,y1[9,:],color='black',linestyle='-',label='COR15A mRNA',linewidth=1.5)
...
x1 = 2.7*np.ones(len(tt1))
x2 = 3*np.ones(len(tt1))
tt2 = np.linspace(2,340,2)
x3 = 2.7*np.ones(len(tt2))
x4 = 3*np.ones(len(tt2))
tt3 = np.linspace(340,341,2)
x5 = 2.7*np.ones(len(tt3))
x6 = 3*np.ones(len(tt3))
tt4 = np.linspace(341,388,2)
x7 = 2.7*np.ones(len(tt4))
x8 = 3*np.ones(len(tt4))
...
plt.subplot(523)
plt.plot(t2,y2[9,:],color='black',linestyle='-',label='COR15A mRNA',linewidth=1.5)
...
plt.subplot(525)
plt.plot(t3,y3[9,:],color='black',linestyle='-',label='COR15A mRNA',linewidth=1.5)
plt.ylabel('Relative expression of COR15A mRNA',font)
...
plt.subplot(527)
plt.plot(t4,y4[9,:],color='black',linestyle='-',label='COR15A mRNA',linewidth=1.5)
...
plt.subplot(5,2,10)
plt.plot(t5,y5[9,:],color='black',linestyle='-',label='COR15A mRNA',linewidth=1.5)
plt.ylim([0,3])
plt.xlim([340,388])
plt.xlabel('Time(h)',font)
plt.xticks(fontproperties = 'Times New Roman', size = 14)
